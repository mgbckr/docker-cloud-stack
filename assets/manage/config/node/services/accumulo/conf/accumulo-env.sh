...
if [[ -z $HADOOP_HOME ]] ; then
   test -z "$HADOOP_PREFIX"      && export HADOOP_PREFIX=/app/services/hadoop
else
...
test -z "$ZOOKEEPER_HOME"        && export ZOOKEEPER_HOME=/app/services/zookeeper
#test -z "$ACCUMULO_LOG_DIR"      && export ACCUMULO_LOG_DIR=$ACCUMULO_HOME/logs
test -z "$ACCUMULO_LOG_DIR"      && export ACCUMULO_LOG_DIR=/app/logs/accumulo
